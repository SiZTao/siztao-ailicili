$(function (){
    var colModel = [
        ...
        {field:'account',title:'账户',width:'8%',align:'center',halign:'center'},
        {field:'nickname',title:'昵称',width:'8%',align:'center',halign:'center'},
        {field:'realname',title:'真实姓名',width:'5%',align:'center',halign:'center'},
        {field:'deptid',title:'所属机构',width:'8%',align:'center',halign:'center'},
        {field:'sex',title:'性别',width:'5%',align:'center',halign:'center'},
        {field:'birthday',title:'出生日期',width:'10%',align:'center',halign:'center'},
        {field:'mobile',title:'手机',width:'8%',align:'center',halign:'center'},
        {field:'position',title:'职位',width:'10%',visible:false},
        {field:'address',title:'住址',width:'8%',visible:false},
        {field:'status',title:'状态',width:'5%',align:'center',halign:'center',formatter:statusFormatter},
        {field:'updatetime',title:'修改时间',width:'8%',align:'center',halign:'center'},
