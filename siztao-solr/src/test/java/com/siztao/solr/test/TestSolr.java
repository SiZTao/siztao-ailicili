package com.siztao.solr.test;


import com.siztao.ailicili.solr.entity.SolrTest;
import com.siztao.ailicili.solr.utils.PageUtils;
import com.siztao.ailicili.solr.utils.SolrUtils;
        ...
        try {
            for (int j=0;j<100;j++){
                for (int i=0;i<docs.length;i++){
                    ...
                    solrTest.setTitle("hxy"+ UUID.randomUUID());
